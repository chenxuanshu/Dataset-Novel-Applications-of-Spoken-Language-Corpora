...
# ===================== 1. 数据加载与标签设置 =====================
df_control = pd.read_excel('../features_data/syntactic_test_control.xlsx')  # 年轻人 48人
df_mci = pd.read_excel('../features_data/syntactic_test_older.xlsx')        # MCI老年人 42人
df_ad = pd.read_excel('../features_data/syntactic_test_ad.xlsx')  
