...
# ===================== 1. 数据加载与标签设置 =====================
df_control = pd.read_excel('../features_data/vocabulary_test_control.xlsx')
df_mci = pd.read_excel('../features_data/vocabulary_test_older.xlsx')
df_ad = pd.read_excel('../features_data/vocabulary_test_ad.xlsx')
